...
public final class CFGWeapons extends ObjectType implements INBTSerializable<NBTTagCompound> {
    ...
    public void buildStructure(ConfigCreator configCreator) {
        ...
        p92 = configCreator.createObject(new CFGWeapon("P92", 7.04f, 14.25f, 0.051f, 0), plugin);
        p1911 = configCreator.createObject(new CFGWeapon("P1911", 8.45f, 9.375f, 0.078f, 1), plugin);
        p18c = configCreator.createObject(new CFGWeapon("P18C", 3.85f, 14.063f, 0.052f, 0), plugin);
        r1895 = configCreator.createObject(new CFGWeapon("R1895", 12.8f, 12.375f, 0.059f, 1), plugin);
        r45 = configCreator.createObject(new CFGWeapon("R45", 13.0f, 12.375f, 0.059f, 1), plugin);
        scorpion = configCreator.createObject(new CFGWeapon("Scorpion", 3.11f, 13.125f, 0.055f, 1), plugin);
        deagle = configCreator.createObject(new CFGWeapon("Deagle", 11.38f, 16.875f, 0.043f, 0), plugin);
        win94 = configCreator.createObject(new CFGWeapon("Wincherster-94", 13.2f, 28.5f, 0.027f, 0), plugin);
        sawedoff = configCreator.createObject(new CFGWeapon("Sawed-off", 4.2f, 12.375f, 0.058f, 0), plugin);
        s1897 = configCreator.createObject(new CFGWeapon("S1897", 5.2f, 13.5f, 0.053f, 0), plugin);
        s686 = configCreator.createObject(new CFGWeapon("S686", 5.2f, 13.875f, 0.052f, 0), plugin);
        s12k = configCreator.createObject(new CFGWeapon("S12K", 4.8f, 13.125f, 0.055f, 0), plugin);
        microuzi = configCreator.createObject(new CFGWeapon("Micro-uzi", 5.2f, 13.125f, 0.057f, 1), plugin);
        ump45 = configCreator.createObject(new CFGWeapon("UMP-45", 8.4f, 13.5f, 0.055f, 1), plugin);
        bizon = configCreator.createObject(new CFGWeapon("PP-19 Bizon", 7.6f, 15.3f, 0.048f, 1), plugin);
        mp5k = configCreator.createObject(new CFGWeapon("MP5-k", 6.8f, 15.3f, 0.048f, 1), plugin);
        vector = configCreator.createObject(new CFGWeapon("Vector 9mm", 5.71f, 13.125f, 0.057f, 1), plugin);
        tommygun = configCreator.createObject(new CFGWeapon("Tommy gun", 8.0f, 10.5f, 0.072f, 1), plugin);
        m16a4 = configCreator.createObject(new CFGWeapon("M16A4", 8.6f, 34.125f, 0.021f, 1), plugin);
        m416 = configCreator.createObject(new CFGWeapon("M416", 8.0f, 33.0f, 0.022f, 1), plugin);
        scarl = configCreator.createObject(new CFGWeapon("Scar-L", 8.4f, 32.625f, 0.022f, 1), plugin);
        qbz = configCreator.createObject(new CFGWeapon("QBZ", 8.4f, 34.875f, 0.021f, 1), plugin);
        g36c = configCreator.createObject(new CFGWeapon("G36C", 8.2f, 33.0f, 0.022f, 1), plugin);
        aug = configCreator.createObject(new CFGWeapon("AUG A3", 11.7f, 34.688f, 0.021f, 1), plugin);
        akm = configCreator.createObject(new CFGWeapon("AKM", 8.6f, 26.813f, 0.027f, 1), plugin);
        m762 = configCreator.createObject(new CFGWeapon("Beryl M762", 8.8f, 27.75f, 0.026f, 1), plugin);
        mk47 = configCreator.createObject(new CFGWeapon("MK-47 Mutant", 9.8f, 29.25f, 0.025f, 1), plugin);
        groza = configCreator.createObject(new CFGWeapon("Groza", 9.6f, 26.813f, 0.027f, 1), plugin);
        m249 = configCreator.createObject(new CFGWeapon("M249", 8.2f, 34.313f, 0.021f, 1), plugin);
        dp28 = configCreator.createObject(new CFGWeapon("DP-28", 9.51f, 31.5f, 0.023f, 1), plugin);
        vss = configCreator.createObject(new CFGWeapon("VSS", 8.6f, 12.375f, 0.067f, 3), plugin);
        mini14 = configCreator.createObject(new CFGWeapon("Mini-14", 9.6f, 37.125f, 0.02f, 1), plugin);
        qbu = configCreator.createObject(new CFGWeapon("QBU", 9.6f, 37.125f, 0.02f, 1), plugin);
        sks = configCreator.createObject(new CFGWeapon("SKS", 10.6f, 30.0f, 0.025f, 1), plugin);
        slr = configCreator.createObject(new CFGWeapon("SLR", 11.2f, 31.5f, 0.024f, 1), plugin);
        mk14 = configCreator.createObject(new CFGWeapon("MK-14 EBR", 12.0f, 37.125f, 0.02f, 1), plugin);
        kar98k = configCreator.createObject(new CFGWeapon("Kar98k", 15.8f, 28.5f, 0.027f, 2), plugin);
        m24 = configCreator.createObject(new CFGWeapon("M24", 15.0f, 29.625f, 0.026f, 2), plugin);
        awm = configCreator.createObject(new CFGWeapon("AWM", 21.0f, 35.775f, 0.021f, 1), plugin);
    }
