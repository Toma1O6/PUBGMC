...
public class C2S_PacketAdjustTeamSpawner implements IMessage {

    private String map;
    private BlockPos pos;
    private TeamType type;

    public C2S_PacketAdjustTeamSpawner() {
    }

    public C2S_PacketAdjustTeamSpawner(String map, BlockPos pos, TeamType type) {
        this.map = map;
        this.pos = pos;
        this.type = type;
    }
    ...
    public static final class Handler implements IMessageHandler<C2S_PacketAdjustTeamSpawner, IMessage> {

        @Override
        public IMessage onMessage(C2S_PacketAdjustTeamSpawner message, MessageContext ctx) {
