...
public class C2S_PacketAdjustCaptureZone implements IMessage {
    ...
    public C2S_PacketAdjustCaptureZone() {
    }

    public C2S_PacketAdjustCaptureZone(String map, BlockPos pos, Vec3d left, Vec3d right, String label) {
        this.map = map;
        this.pos = pos;
        this.left = left;
        this.right = right;
    ...
    public static final class Handler implements IMessageHandler<C2S_PacketAdjustCaptureZone, IMessage> {

        @Override
        public IMessage onMessage(C2S_PacketAdjustCaptureZone message, MessageContext ctx) {
