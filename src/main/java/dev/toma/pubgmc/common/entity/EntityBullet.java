...
public class EntityBullet extends Entity {
    ...
    public static final Function<Entity, AxisAlignedBB> BOUNDING_BOX_PROVIDER = entity -> entity instanceof CustomProjectileBoundingBoxProvider ? ((CustomProjectileBoundingBoxProvider) entity).getBoundingBoxForProjectiles() : entity.getEntityBoundingBox();
    ...
    public void onBulletCollided(RayTraceResult rayTraceResult) {
        ...
        if (entity != null && !world.isRemote) {
            ...
            Vec3d hitPos = entityRaytrace != null && entityRaytrace.hitVec != null ? entityRaytrace.hitVec : rayTraceResult.hitVec;
            this.onEntityHit(isHeadshot, entity, hitPos);
