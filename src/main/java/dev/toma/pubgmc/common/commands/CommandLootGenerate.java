...
import dev.toma.pubgmc.network.sp.PacketDisplayLootSetupGui;
...
public class CommandLootGenerate extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (sender.getEntityWorld().hasCapability(IWorldData.WorldDataProvider.WORLD_DATA, null)) {
            worldData = sender.getEntityWorld().getCapability(IWorldData.WorldDataProvider.WORLD_DATA, null);
        }
    ...
    private void executeBasic(MinecraftServer server, ICommandSender sender, String[] args, IWorldData data) {
        ...
        if (args[0].equalsIgnoreCase("help")) {
            ...
            IGameData game = world.getCapability(IGameData.GameDataProvider.GAMEDATA, null);
            int count = 0;
