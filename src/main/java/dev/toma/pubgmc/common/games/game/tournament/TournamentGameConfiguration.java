...
public class TournamentGameConfiguration implements TeamGameConfiguration {
    ...
    public int requiredTeamCount = 4;
    public int winScore = 3;
    public int drawScore = 1;
    public boolean hardcoreMode;
    public int loadoutSelectTime = 1200;
    public int matchWaitTime = 100;
    public int matchStartTime = 60;
    public int matchEndTime = 60;
    ...
    public boolean hasCaptureZones() {
        return placementRoundConfig.hasCaptureZoneEnabled() || qualificationRoundConfig.hasCaptureZoneEnabled() || finalRoundConfig.hasCaptureZoneEnabled();
    }
    ...
    public void performCorrections() {
        ...
        this.matchStartTime = Math.max(60, matchStartTime);
        this.matchEndTime = Math.max(60, matchEndTime);
    ...
    public static final class MatchConfiguration {
        ...
        public static final MatchConfiguration DEFAULT_PLACEMENT = new MatchConfiguration(3, 2400, 2400, 200, 30, false, 0, 0, 0);
        public static final MatchConfiguration DEFAULT_QUALIFICATION = new MatchConfiguration(1, 2400, 2400, 200, 30, true, 600, 1, 50);
        public static final MatchConfiguration DEFAULT_FINAL = new MatchConfiguration(5, 3600, 2400, 200, 30, true, 600, 1, 40);

        public int matchCount;
        public int killRoundDuration;
        public int captureRoundDuration;
        public int captureTime;
        public int hitCapturePenalty;
        public boolean endRound;
        public int endRoundAiSpawnInterval;
        public int endOfRoundDamage;
        public int endOfRoundDamageInterval;

        public MatchConfiguration(int matchCount, int killRoundDuration, int captureRoundDuration, int captureTime, int hitCapturePenalty, boolean endRound, int endRoundAiSpawnInterval, int endOfRoundDamage, int endOfRoundDamageInterval) {
            this.matchCount = matchCount;
            this.killRoundDuration = killRoundDuration;
            this.captureRoundDuration = captureRoundDuration;
            this.captureTime = captureTime;
            this.hitCapturePenalty = hitCapturePenalty;
        ...
        public void correct() {
            ...
            this.hitCapturePenalty = Math.max(0, hitCapturePenalty);
        ...
        public boolean hasCaptureZoneEnabled() {
            return captureRoundDuration > 0;
        }
        ...
        public void serialize(DataWriter<?> writer) {
            ...
            writer.writeInt("hitCapturePenalty", hitCapturePenalty);
        ...
        public static MatchConfiguration deserialize(DataReader<?> reader) {
            ...
            int capturePenalty = reader.readInt("hitCapturePenalty");
            ...
            return new MatchConfiguration(matchCount, killRoundDuration, captureRoundDuration, captureTime, capturePenalty, allowEndRound, endRoundAiSpawnInterval, endOfRoundDamage, endOfRoundDamageInterval);
        }
    }
}
