...
public final class MapPointRendererManager {
    ...
    private void renderPoints(Collection<GameMapPoint> points, boolean debugMode, @Nullable Game<?> game, double x, double y, double z, float partialTicks) {
        for (GameMapPoint point : points) {
            renderPoint(point, debugMode, game, x, y, z, partialTicks);
        }
    }

    private <P extends GameMapPoint> void renderPoint(P point, boolean debugMode, @Nullable Game<?> game, double x, double y, double z, float partialTicks) {
