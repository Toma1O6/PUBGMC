...
public class ModelVSS extends ModelGun {
    ...
    private static final ResourceLocation TEXTURE = Pubgmc.getResource("textures/overlay/scopevss.png");
    ...
    public ModelVSS() {
        ...
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.0F, -39.3049F, -4.8726F, 2, 1, 9, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -0.5F, -38.7567F, 3.3034F, 1, 0, 10, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.0F, -39.3049F, 13.1274F, 2, 1, 4, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.0F, -38.5978F, -14.8726F, 2, 0, 10, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.866F, -37.3907F, 3.3034F, 0, 1, 10, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -2.4142F, -37.8907F, 13.1274F, 1, 2, 4, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -2.4142F, -37.8907F, -4.8726F, 1, 2, 9, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.7071F, -37.8907F, -14.8726F, 0, 2, 10, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 88, 81, 1.7071F, -37.8907F, -14.8726F, 0, 2, 10, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, 1.4142F, -37.8907F, -4.8726F, 1, 2, 9, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, 1.866F, -37.3907F, 3.3034F, 0, 1, 10, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, 1.4142F, -37.8907F, 13.1274F, 1, 2, 4, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.0F, -35.1836F, -14.8726F, 2, 0, 10, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.0F, -35.4765F, -4.8726F, 2, 1, 9, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -0.5F, -35.0247F, 3.3034F, 1, 0, 10, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 88, 81, -1.0F, -35.4765F, 13.1274F, 2, 1, 4, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 77, 33, -1.0F, -40.3049F, -1.3726F, 2, 1, 2, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 77, 33, -1.5F, -40.7049F, -1.8726F, 3, 1, 3, 0.0F, true));
        scope.cubeList.add(new ModelBox(scope, 77, 33, -3.4142F, -37.8907F, -1.3726F, 1, 2, 2, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 77, 33, -3.8142F, -38.3907F, -1.8726F, 1, 3, 3, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 20, 158, 3.064F, -36.0F, -4.14F, 1, 7, 2, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 20, 158, 2.064F, -38.0F, -4.14F, 2, 2, 2, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 20, 158, 2.232F, -38.344F, 1.268F, 1, 8, 2, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 20, 158, 2.824F, -31.0F, 0.668F, 1, 3, 3, 0.0F, false));
        scope.cubeList.add(new ModelBox(scope, 20, 158, 2.728F, -30.5F, -4.332F, 1, 2, 5, 0.0F, false));

        bone29 = new ModelRenderer(this);
        bone29.setRotationPoint(-1.366F, -37.8547F, -0.3726F);
        scope.addChild(bone29);
        setRotationAngle(bone29, 0.0F, 0.0F, -0.7854F);
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, 1.6985F, 0.6476F, -4.5F, 1, 2, 9, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, 1.6985F, 0.6476F, 13.5F, 1, 2, 4, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, 2.1985F, 1.1476F, -14.5F, 0, 1, 10, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -0.2157F, -0.2666F, -14.5F, 1, 0, 10, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -0.2157F, 3.5618F, -14.5F, 1, 0, 10, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -1.6299F, 1.1476F, -14.5F, 0, 1, 10, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -0.7157F, 3.0618F, -4.5F, 2, 1, 9, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -0.7157F, 3.0618F, 13.5F, 2, 1, 4, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -0.7157F, -0.7666F, -4.5F, 2, 1, 9, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -0.7157F, -0.7666F, 13.5F, 2, 1, 4, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -2.1299F, 0.6476F, -4.5F, 1, 2, 9, 0.0F, false));
        bone29.cubeList.add(new ModelBox(bone29, 88, 81, -2.1299F, 0.6476F, 13.5F, 1, 2, 4, 0.0F, false));

        bone30 = new ModelRenderer(this);
        bone30.setRotationPoint(2.0F, -31.0547F, -32.5766F);
        scope.addChild(bone30);
        setRotationAngle(bone30, 0.0F, 0.0F, -0.5236F);
        bone30.cubeList.add(new ModelBox(bone30, 88, 81, 0.6859F, -7.9201F, 35.88F, 1, 0, 10, 0.0F, true));
        bone30.cubeList.add(new ModelBox(bone30, 88, 81, 3.052F, -6.5541F, 35.88F, 0, 1, 10, 0.0F, true));
        bone30.cubeList.add(new ModelBox(bone30, 88, 81, -0.6801F, -6.5541F, 35.88F, 0, 1, 10, 0.0F, true));
        bone30.cubeList.add(new ModelBox(bone30, 88, 81, 0.6859F, -4.1881F, 35.88F, 1, 0, 10, 0.0F, true));

        bone31 = new ModelRenderer(this);
        bone31.setRotationPoint(-2.0F, -31.0547F, -32.5766F);
        scope.addChild(bone31);
        setRotationAngle(bone31, 0.0F, 0.0F, 0.5236F);
        bone31.cubeList.add(new ModelBox(bone31, 88, 81, -3.052F, -6.5541F, 35.88F, 0, 1, 10, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 88, 81, -1.6859F, -7.9201F, 35.88F, 1, 0, 10, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 88, 81, 0.6801F, -6.5541F, 35.88F, 0, 1, 10, 0.0F, false));
        bone31.cubeList.add(new ModelBox(bone31, 88, 81, -1.6859F, -4.1881F, 35.88F, 1, 0, 10, 0.0F, false));

        bone22 = new ModelRenderer(this);
        bone22.setRotationPoint(-1.9142F, -36.8907F, 17.6274F);
        scope.addChild(bone22);
        setRotationAngle(bone22, 0.0F, -0.2618F, 0.7854F);
        bone22.cubeList.add(new ModelBox(bone22, 88, 81, -2.1892F, -2.3536F, -6.0721F, 0, 2, 2, 0.0F, false));

        bone24 = new ModelRenderer(this);
        bone24.setRotationPoint(0.0F, -38.8049F, 17.6274F);
        scope.addChild(bone24);
        setRotationAngle(bone24, 0.2618F, 0.0F, 0.0F);
        bone24.cubeList.add(new ModelBox(bone24, 88, 81, -1.0F, -1.6476F, -6.2173F, 2, 0, 2, 0.0F, true));

        bone21 = new ModelRenderer(this);
        bone21.setRotationPoint(-1.9142F, -36.8907F, 17.6274F);
        scope.addChild(bone21);
        setRotationAngle(bone21, 0.0F, -0.2618F, 0.0F);
        bone21.cubeList.add(new ModelBox(bone21, 88, 81, -1.6476F, -1.0F, -6.2173F, 0, 2, 2, 0.0F, false));

        bone25 = new ModelRenderer(this);
        bone25.setRotationPoint(0.0F, -44.1951F, 17.6274F);
        scope.addChild(bone25);
        setRotationAngle(bone25, -0.2618F, 0.0F, 0.0F);
        bone25.cubeList.add(new ModelBox(bone25, 88, 81, -1.0F, 10.5522F, -3.8313F, 2, 0, 2, 0.0F, true));

        bone26 = new ModelRenderer(this);
        bone26.setRotationPoint(-1.9142F, 36.8907F, 17.6274F);
        scope.addChild(bone26);
        setRotationAngle(bone26, 0.0F, -0.2618F, -0.7854F);
        bone26.cubeList.add(new ModelBox(bone26, 88, 81, 48.2044F, -51.8178F, -19.5751F, 0, 2, 2, 0.0F, false));

        bone27 = new ModelRenderer(this);
        bone27.setRotationPoint(1.9142F, 36.8907F, 17.6274F);
        scope.addChild(bone27);
        setRotationAngle(bone27, 0.0F, 0.2618F, 0.7854F);
        bone27.cubeList.add(new ModelBox(bone27, 88, 81, -48.2044F, -51.8178F, -19.5751F, 0, 2, 2, 0.0F, true));

        bone20 = new ModelRenderer(this);
        bone20.setRotationPoint(1.9142F, -36.8907F, 17.6274F);
        scope.addChild(bone20);
        setRotationAngle(bone20, 0.0F, 0.2618F, 0.0F);
        bone20.cubeList.add(new ModelBox(bone20, 88, 81, 1.6476F, -1.0F, -6.2173F, 0, 2, 2, 0.0F, true));

        bone23 = new ModelRenderer(this);
        bone23.setRotationPoint(1.9142F, -36.8907F, 17.6274F);
        scope.addChild(bone23);
        setRotationAngle(bone23, 0.0F, 0.2618F, -0.7854F);
        bone23.cubeList.add(new ModelBox(bone23, 88, 81, 2.1892F, -2.3536F, -6.0721F, 0, 2, 2, 0.0F, true));

        reticle = new ModelRenderer(this);
        reticle.setRotationPoint(0.0F, 24.0F, 0.0F);
        reticle.cubeList.add(new ExtendedModelBox(reticle, -1.5F, -38.4F, 16.5F, 3, 3, 0, 0.0F));

        overlay = new ModelRenderer(this);
        overlay.setRotationPoint(0.0F, 24.0F, 0.0F);
        overlay.cubeList.add(new ExtendedModelBox(overlay, -1.5F, -38.4F, 16.8F, 3, 3, 0, 0.0F));
        overlay.cubeList.add(new ExtendedModelBox(overlay, -1.5F, -38.4F, -14.2F, 3, 3, 0, 0.0F));
