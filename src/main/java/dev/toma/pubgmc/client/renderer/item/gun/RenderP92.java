...
public class RenderP92 extends WeaponRenderer {
    ...
    public void registerAttachmentRenders() {
        registerRenderConfig(PMCItems.SILENCER_SMG, IRenderConfig.positioned(0.0925F, 0.025F, 0.66F));
        registerRenderConfig(PMCItems.RED_DOT, IRenderConfig.positionedScaled(0.195F, 0.14F, 0.06F, 0.8F, 0.8F, 0.8F));
    }
