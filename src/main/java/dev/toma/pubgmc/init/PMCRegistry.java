...
import dev.toma.pubgmc.common.items.guns.attachments.IAttachment.Type;
    ...
    public static class Registry {
        ...
        public static void registerItems(Register<Item> event) {
            final Item[] ITEMS = {
                    ...
                    new ArmorBase("armor1helmet", PMCRegistry.ToolMaterials.LVL1, 1, EntityEquipmentSlot.HEAD, ArmorBase.ArmorLevel.LEVEL_ONE),
                    new ArmorBase("armor1body", PMCRegistry.ToolMaterials.LVL1, 1, EntityEquipmentSlot.CHEST, ArmorBase.ArmorLevel.LEVEL_ONE),
                    new ArmorBase("armor2helmet", PMCRegistry.ToolMaterials.LVL2, 1, EntityEquipmentSlot.HEAD, ArmorBase.ArmorLevel.LEVEL_TWO),
                    new ArmorBase("armor2body", PMCRegistry.ToolMaterials.LVL2, 1, EntityEquipmentSlot.CHEST, ArmorBase.ArmorLevel.LEVEL_TWO),
                    new ArmorBase("armor3helmet", PMCRegistry.ToolMaterials.LVL3, 1, EntityEquipmentSlot.HEAD, ArmorBase.ArmorLevel.LEVEL_THREE),
                    new ArmorBase("armor3body", PMCRegistry.ToolMaterials.LVL3, 1, EntityEquipmentSlot.CHEST, ArmorBase.ArmorLevel.LEVEL_THREE),
        ...
        @SubscribeEvent
        public static void registerGameModes(dev.toma.pubgmc.init.GameRegistry.GameRegisterEvent e) {
            e.registerAll(
        ...
        private static GunBase[] getInitializedGuns() {
            ...
            GunBase p92 = GunBuilder.create("p92")
                    ...
                    .firerate(2)
                    .recoil(2f, 0.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 25, PMCSounds.reload_p92)
                    .ammo(AmmoType.AMMO9MM, 15, 20)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.SINGLE)
            ...
            GunBase p1911 = GunBuilder.create("p1911")
                    ...
                    .firerate(2)
                    .recoil(2f, 0.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 25, PMCSounds.reload_p1911)
            ...
            GunBase p18c = GunBuilder.create("p18c")
                    ...
                    .firerate(1)
                    .recoil(1.5f, 0.75f)
                    .reload(GunBase.ReloadType.MAGAZINE, 34, PMCSounds.reload_p18c)
                    .ammo(AmmoType.AMMO9MM, 17, 25)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.PISTOL)
            ...
            GunBase r1895 = GunBuilder.create("r1895")
                    ...
                    .firerate(13)
                    .recoil(2.5f, 1.5f)
                    .reload(GunBase.ReloadType.SINGLE, 14, PMCSounds.reload_r1895)
            ...
            GunBase r45 = GunBuilder.create("r45")
                    ...
                    .firerate(12)
                    .recoil(2f, 1.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 40, PMCSounds.reload_r45)
            ...
            GunBase scorpion = GunBuilder.create("scorpion")
                    ...
                    .firerate(1)
                    .recoil(1.3f, 0.3f)
                    .reload(GunBase.ReloadType.MAGAZINE, 57, PMCSounds.reload_scorpion)
            ...
            GunBase deagle = GunBuilder.create("deagle")
                    ...
                    .firerate(4)
                    .recoil(4.5f, 3f)
                    .reload(GunBase.ReloadType.MAGAZINE, 50, PMCSounds.reload_deagle)
            ...
            GunBase win94 = GunBuilder.create("win94")
                    ...
                    .firerate(25)
                    .recoil(5.5f, 3.5f)
                    .reload(GunBase.ReloadType.SINGLE, 15, PMCSounds.reload_win94)
            ...
            GunBase sawedoff = GunBuilder.create("sawed_off")
                    ...
                    .firerate(10)
                    .recoil(3.5f, 2f)
                    .reload(GunBase.ReloadType.MAGAZINE, 70, PMCSounds.reload_sawedoff)
            ...
            GunBase s1897 = GunBuilder.create("s1897")
                    ...
                    .firerate(15)
                    .recoil(3.5f, 2f)
                    .reload(GunBase.ReloadType.SINGLE, 10, PMCSounds.reload_s1897)
            ...
            GunBase s686 = GunBuilder.create("s686")
                    ...
                    .firerate(5)
                    .recoil(3.5f, 2f)
                    .reload(GunBase.ReloadType.MAGAZINE, 48, PMCSounds.reload_s686)
                    .ammo(AmmoType.AMMO12G, 2)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.SINGLE)
                    .weaponType(GunBase.GunType.SHOTGUN)
            ...
            GunBase s12k = GunBuilder.create("s12k")
                    ...
                    .firerate(7)
                    .recoil(6f, 2f)
                    .reload(GunBase.ReloadType.MAGAZINE, 65, PMCSounds.reload_s12k)
                    .ammo(AmmoType.AMMO12G, 5)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.SINGLE)
                    .weaponType(GunBase.GunType.SHOTGUN)
            ...
            GunBase uzi = GunBuilder.create("microuzi")
                    ...
                    .firerate(1)
                    .recoil(2f, 0.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 56, PMCSounds.reload_microuzi)
            ...
            GunBase vector = GunBuilder.create("vector")
                    ...
                    .firerate(1)
                    .recoil(2f, 0.6f)
                    .reload(GunBase.ReloadType.MAGAZINE, 30, PMCSounds.reload_vector)
                    .ammo(AmmoType.AMMO9MM, 19, 33)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.all())
                    .weaponType(GunBase.GunType.SMG)
                    .setTwoRoundBurst()
            ...
            GunBase bizon = GunBuilder.create("bizon")
                    ...
                    .firerate(2)
                    .recoil(2.0f, 0.7f)
                    .reload(GunBase.ReloadType.MAGAZINE, 62, PMCSounds.reload_bizon)
            ...
            GunBase mp5k = GunBuilder.create("mp5k")
                    ...
                    .firerate(2)
                    .recoil(2f, 0.7f)
                    .reload(GunBase.ReloadType.MAGAZINE, 64, PMCSounds.reload_mp5k)
            ...
            GunBase tommy = GunBuilder.create("tommy_gun")
                    ...
                    .firerate(2)
                    .recoil(2f, 0.75f)
                    .reload(GunBase.ReloadType.MAGAZINE, 60, PMCSounds.reload_tommygun)
            ...
            GunBase ump = GunBuilder.create("ump45")
                    ...
                    .firerate(2)
                    .recoil(1.9f, 0.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 52, PMCSounds.reload_ump9)
            ...
            GunBase m16a4 = GunBuilder.create("m16a4")
                    ...
                    .firerate(2)
                    .recoil(2.0f, 1f)
                    .reload(GunBase.ReloadType.MAGAZINE, 66, PMCSounds.reload_m16a4)
                    .ammo(AmmoType.AMMO556, 30, 40)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.noAuto())
            ...
            GunBase m416 = GunBuilder.create("m416")
                    ...
                    .firerate(2)
                    .recoil(2.25f, 1.0f)
                    .reload(GunBase.ReloadType.MAGAZINE, 66, PMCSounds.reload_m416)
                    .ammo(AmmoType.AMMO556, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.AR)
            ...
            GunBase scarl = GunBuilder.create("scar_l")
                    ...
                    .firerate(2)
                    .recoil(2.0f, 1.0f)
                    .reload(GunBase.ReloadType.MAGAZINE, 65, PMCSounds.reload_scarl)
                    .ammo(AmmoType.AMMO556, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.AR)
            ...
            GunBase qbz = GunBuilder.create("qbz")
                    ...
                    .firerate(2)
                    .recoil(2.0f, 1.0f)
                    .reload(GunBase.ReloadType.MAGAZINE, 70, PMCSounds.reload_qbz)
                    .ammo(AmmoType.AMMO556, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.AR)
            ...
            GunBase g36c = GunBuilder.create("g36c")
                    ...
                    .firerate(2)
                    .recoil(2.25f, 0.8f)
                    .reload(GunBase.ReloadType.MAGAZINE, 82, PMCSounds.reload_g36c)
                    .ammo(AmmoType.AMMO556, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.AR)
            ...
            GunBase aug = GunBuilder.create("aug")
                    ...
                    .firerate(2)
                    .recoil(2.3f, 0.75f)
                    .reload(GunBase.ReloadType.MAGAZINE, 69, PMCSounds.reload_aug)
                    .ammo(AmmoType.AMMO556, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.AR)
                    .airdropOnly()
            ...
            GunBase akm = GunBuilder.create("akm")
                    ...
                    .firerate(2)
                    .recoil(2.7f, 1.3f)
                    .reload(GunBase.ReloadType.MAGAZINE, 60, PMCSounds.reload_akm)
            ...
            GunBase m762 = GunBuilder.create("beryl_m762")
                    ...
                    .firerate(2)
                    .recoil(2.9f, 1.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 50, PMCSounds.reload_m762)
                    .ammo(AmmoType.AMMO762, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.all())
                    .weaponType(GunBase.GunType.AR)
            ...
            GunBase mk47 = GunBuilder.create("mk47_mutant")
                    ...
                    .firerate(2)
                    .recoil(2.7f, 1.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 66, PMCSounds.reload_mk47)
                    .ammo(AmmoType.AMMO762, 20, 30)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.noAuto()).weaponType(GunBase.GunType.AR)
                    .setTwoRoundBurst()
            ...
            GunBase groza = GunBuilder.create("groza")
                    ...
                    .firerate(2)
                    .recoil(2.5f, 1.2f)
                    .reload(GunBase.ReloadType.MAGAZINE, 50, PMCSounds.reload_groza)
                    .ammo(AmmoType.AMMO762, 30, 40)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.AR)
                    .airdropOnly()
            ...
            GunBase dp28 = GunBuilder.create("dp28")
                    ...
                    .firerate(2)
                    .recoil(2.5f, 1.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 95, PMCSounds.reload_dp28)
                    .ammo(AmmoType.AMMO762, 47)
                    .firemode(GunBase.Firemode.AUTO, GunBase.Firemode.AUTO)
            ...
            GunBase m249 = GunBuilder.create("m249")
                    ...
                    .firerate(2)
                    .recoil(2.0f, 0.9f)
                    .reload(GunBase.ReloadType.MAGAZINE, 148, PMCSounds.reload_m249)
            ...
            GunBase vss = GunBuilder.create("vss")
                    ...
                    .firerate(2)
                    .recoil(1.5f, 0.5f)
                    .reload(GunBase.ReloadType.MAGAZINE, 40, PMCSounds.reload_vss)
            ...
            GunBase mini14 = GunBuilder.create("mini14")
                    ...
                    .firerate(1)
                    .recoil(3.5f, 2f)
                    .reload(GunBase.ReloadType.MAGAZINE, 62, PMCSounds.reload_mini14)
            ...
            GunBase qbu = GunBuilder.create("qbu")
                    ...
                    .firerate(1)
                    .recoil(3.5f, 2f)
                    .reload(GunBase.ReloadType.MAGAZINE, 44, PMCSounds.reload_qbu)
            ...
            GunBase sks = GunBuilder.create("sks")
                    ...
                    .firerate(1)
                    .recoil(5.5f, 2.25f)
                    .reload(GunBase.ReloadType.MAGAZINE, 32, PMCSounds.reload_sks)
            ...
            GunBase slr = GunBuilder.create("slr")
                    ...
                    .firerate(1)
                    .recoil(5.75f, 2.25f)
                    .reload(GunBase.ReloadType.MAGAZINE, 53, PMCSounds.reload_slr)
                    .ammo(AmmoType.AMMO762, 10, 20)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.SINGLE)
                    .weaponType(GunBase.GunType.DMR)
            ...
            GunBase mk14 = GunBuilder.create("mk14")
                    ...
                    .firerate(2)
                    .recoil(7.5f, 3.25f)
                    .reload(GunBase.ReloadType.MAGAZINE, 39, PMCSounds.reload_mk14)
                    .ammo(AmmoType.AMMO762, 10, 20)
                    .firemode(GunBase.Firemode.SINGLE, GunBase.Firemode.noBurst())
                    .weaponType(GunBase.GunType.DMR)
                    .airdropOnly()
            ...
            GunBase kar98k = GunBuilder.create("kar98k")
                    ...
                    .firerate(30)
                    .recoil(2.5f, 1.25f)
                    .reload(GunBase.ReloadType.KAR98K, 63, PMCSounds.reload_kar98k)
            ...
            GunBase m24 = GunBuilder.create("m24")
                    ...
                    .firerate(35)
                    .recoil(2.5f, 1.25f)
                    .reload(GunBase.ReloadType.MAGAZINE, 71, PMCSounds.reload_m24)
            ...
            GunBase awm = GunBuilder.create("awm")
                    ...
                    .firerate(35)
                    .recoil(2.5f, 1.25f)
                    .reload(GunBase.ReloadType.MAGAZINE, 78, PMCSounds.reload_awm)
