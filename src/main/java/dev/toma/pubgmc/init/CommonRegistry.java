...
public class CommonRegistry {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        registry.registerAll(
                ...
                new ItemAmmo("ammo_556", AmmoType.AMMO556, 40),
                new ItemAmmo("ammo_762", AmmoType.AMMO762, 30),
                new ItemAmmo("ammo_300m", AmmoType.AMMO300M, 20),
                new ItemAmmo("ammo_flare", AmmoType.FLARE, 40),
                ...
                new ItemBulletproofArmor("armor1helmet", ToolMaterials.LV1_HELMET, 1, EntityEquipmentSlot.HEAD, ItemBulletproofArmor.ArmorLevel.LEVEL_ONE),
                new ItemBulletproofArmor("armor1body", ToolMaterials.LV1_VEST, 1, EntityEquipmentSlot.CHEST, ItemBulletproofArmor.ArmorLevel.LEVEL_ONE),
                new ItemBulletproofArmor("armor2helmet", ToolMaterials.LV2_HELMET, 1, EntityEquipmentSlot.HEAD, ItemBulletproofArmor.ArmorLevel.LEVEL_TWO),
                new ItemBulletproofArmor("armor2body", ToolMaterials.LV2_VEST, 1, EntityEquipmentSlot.CHEST, ItemBulletproofArmor.ArmorLevel.LEVEL_TWO),
                new ItemBulletproofArmor("armor3helmet", ToolMaterials.LV3_HELMET, 1, EntityEquipmentSlot.HEAD, ItemBulletproofArmor.ArmorLevel.LEVEL_THREE),
                new ItemBulletproofArmor("armor3body", ToolMaterials.LV3_VEST, 1, EntityEquipmentSlot.CHEST, ItemBulletproofArmor.ArmorLevel.LEVEL_THREE),
