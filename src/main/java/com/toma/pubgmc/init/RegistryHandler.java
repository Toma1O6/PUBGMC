...
public class RegistryHandler
{
	...
	public static void registerItems(Register<Item> event)
	{
		final Item[] ITEMS = {
				...
				new ItemAttachment("silencer_pistol", Type.BARREL, GunType.PISTOL),
				new ItemAttachment("silencer_smg", Type.BARREL, GunType.SMG),
				new ItemAttachment("silencer_ar", Type.BARREL, GunType.AR),
				new ItemAttachment("silencer_sniper", Type.BARREL, GunType.SNIPER),
				new ItemAttachment("compensator_smg", Type.BARREL, GunType.SMG),
				new ItemAttachment("compensator_ar", Type.BARREL, GunType.AR),
				new ItemAttachment("compensator_sniper", Type.BARREL, GunType.SNIPER),
				new ItemAttachment("red_dot", Type.SCOPE, GunType.ALL),
				new ItemAttachment("holographic", Type.SCOPE, GunType.ALL),
				new ItemAttachment("scope2x", Type.SCOPE, GunType.ALL),
				new ItemAttachment("scope4x", Type.SCOPE, GunType.ALL),
				new ItemAttachment("scope8x", Type.SCOPE, GunType.ALL),
				new ItemAttachment("scope15x", Type.SCOPE, GunType.SNIPER),
				new ItemAttachment("grip_vertical", Type.GRIP, GunType.ALL),
				new ItemAttachment("grip_angled", Type.GRIP, GunType.ALL),
				new ItemAttachment("quickdraw_mag_pistol", Type.MAGAZINE, GunType.PISTOL),
				new ItemAttachment("extended_mag_pistol", Type.MAGAZINE, GunType.PISTOL),
				new ItemAttachment("extended_quickdraw_mag_pistol", Type.MAGAZINE, GunType.PISTOL),
				new ItemAttachment("quickdraw_mag_smg", Type.MAGAZINE, GunType.SMG),
				new ItemAttachment("extended_mag_smg", Type.MAGAZINE, GunType.SMG),
				new ItemAttachment("extended_quickdraw_mag_smg", Type.MAGAZINE, GunType.SMG),
				new ItemAttachment("quickdraw_mag_ar", Type.MAGAZINE, GunType.AR),
				new ItemAttachment("extended_mag_ar", Type.MAGAZINE, GunType.AR),
				new ItemAttachment("extended_quickdraw_mag_ar", Type.MAGAZINE, GunType.AR),
				new ItemAttachment("quickdraw_mag_sniper", Type.MAGAZINE, GunType.SNIPER),
				new ItemAttachment("extended_mag_sniper", Type.MAGAZINE, GunType.SNIPER),
				new ItemAttachment("extended_quickdraw_mag_sniper", Type.MAGAZINE, GunType.SNIPER),
				new ItemAttachment("bullet_loops_shotgun", Type.STOCK, GunType.SHOTGUN),
				new ItemAttachment("bullet_loops_sniper", Type.STOCK, GunType.ALL),
				new ItemAttachment("cheekpad", Type.STOCK, GunType.SNIPER),
				new ItemParachute("parachute"),
				new PMCItem("steel_dust"),
				new PMCItem("steel_ingot"),
				new PMCItem("copper_ingot"),
				new ItemVehicleSpawner("vehicle_test", 0)
		};
