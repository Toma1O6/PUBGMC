...
public class ConfigHandler
{
	...
	public static void init(File file)
	{
		...
		config.addCustomCategoryComment(category, "Gun settings");
			...
			m16a4 = config.getFloat("M16A4 Damage", category, 7.0f, 1.0f, 35.0f, "Set damage for M16A4");
			m416 = config.getFloat("M416 Damage", category, 7.0f, 1.0f, 35.0f, "Set damage for M416");
			qbz = config.getFloat("QBZ Damage", category, 7.0f, 1.0f, 35.0f, "Set damage for QBZ");
			scarl = config.getFloat("Scar-L Damage", category, 7.0f, 1.0f, 35.0f, "Set damage for Scar-L");
			aug = config.getFloat("AUG Damage", category, 7.0f, 1.0f, 35.0f, "Set damage for AUG");
			akm = config.getFloat("AKM Damage", category, 9.0f, 1.0f, 45.0f, "Set damage for AKM");
			mk47 = config.getFloat("Mk-47 Mutant Damage", category, 8.0f, 1.0f, 40.0f, "Set damage for Mk-47 Mutant");
			m762 = config.getFloat("Beryl M762 Damage", category, 9.0f, 1.0f, 45.0f, "Set damage for Beryl M762");
			groza = config.getFloat("Groza Damage", category, 10.0f, 1.0f, 50.0f, "Set damage for Groza");
			m249 = config.getFloat("M249 Damage", category, 7.0f, 1.0f, 35.0f, "Set damage for M249");
			dp28 = config.getFloat("DP-28 Damage", category, 8.0f, 1.0f, 40.0f, "Set damage for DP-28");
			...
			sks = config.getFloat("SKS Damage", category, 11.0f, 1.0f, 55.0f, "Set damage for SKS");
			slr = config.getFloat("SLR Damage", category, 12.5f, 1.0f, 62.5f, "Set damage for SLR");
			mk14 = config.getFloat("Mk-14 Damage", category, 14.0f, 1.0f, 70.0f, "Set damage for Mk-14");
