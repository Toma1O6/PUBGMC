...
public class AttachmentSuppressorSMG extends ModelAtachmentBase {
	private final ModelRenderer bone;
	private final ModelRenderer bone2;
	private final ModelRenderer bone3;

	public AttachmentSuppressorSMG() {
		textureWidth = 128;
		textureHeight = 128;

		bone = new ModelRenderer(this);
		bone.setRotationPoint(0.0F, 24.0F, 0.0F);
		bone.cubeList.add(new ModelBox(bone, 70, 68, -1.0F, 1.7321F, -2.1719F, 2, 2, 16, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 70, 68, -3.7321F, -1.0F, -2.1719F, 3, 2, 16, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 70, 68, 0.7321F, -1.0F, -2.1719F, 3, 2, 16, 0.0F, true));
		bone.cubeList.add(new ModelBox(bone, 70, 68, -1.0F, -3.7321F, -2.1719F, 2, 2, 16, 0.0F, false));
		...
		bone2.cubeList.add(new ModelBox(bone2, 70, 68, -1.0F, -0.2679F, -2.1719F, 2, 4, 16, 0.0F, false));
		bone2.cubeList.add(new ModelBox(bone2, 70, 68, 0.7321F, -1.0F, -2.1719F, 3, 2, 16, 0.0F, false));
		bone2.cubeList.add(new ModelBox(bone2, 70, 68, -3.7321F, -1.0F, -2.1719F, 3, 2, 16, 0.0F, true));
		bone2.cubeList.add(new ModelBox(bone2, 70, 68, -1.0F, -3.7321F, -2.1719F, 2, 4, 16, 0.0F, true));
		...
		bone3.cubeList.add(new ModelBox(bone3, 70, 68, -1.0F, -0.2679F, -2.1719F, 2, 4, 16, 0.0F, false));
		bone3.cubeList.add(new ModelBox(bone3, 70, 68, -3.7321F, -1.0F, -2.1719F, 3, 2, 16, 0.0F, false));
		bone3.cubeList.add(new ModelBox(bone3, 70, 68, -1.0F, -3.7321F, -2.1719F, 2, 4, 16, 0.0F, true));
		bone3.cubeList.add(new ModelBox(bone3, 70, 68, 0.7321F, -1.0F, -2.1719F, 3, 2, 16, 0.0F, true));
