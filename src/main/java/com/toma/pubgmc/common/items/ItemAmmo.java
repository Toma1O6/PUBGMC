...
public class ItemAmmo extends PMCItem implements ICraftable
{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
		switch(type)
		{
			case AMMO9MM: tooltip.add(TextFormatting.GOLD + "For guns: P92, P18C, Micro-Uzi, Ump-9, VSS"); break;
			...
			case AMMO556: tooltip.add(TextFormatting.GREEN + "For guns: M16A4, M416, Scar-L, QBZ, QBU, Mini-14, Aug, M249"); break;
