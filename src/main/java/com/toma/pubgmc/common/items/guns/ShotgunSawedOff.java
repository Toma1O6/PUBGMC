...
public class ShotgunSawedOff extends GunBase
{
	...
	public ShotgunSawedOff(String name) 
	{
		...
		this.setGunSound(PMCSounds.gun_sawed_off);
	...
	{
		return PMCSounds.reload_sawedoff;
	}
	
	@Override
	public ModelGun getWeaponModel()
	{
		return ((WeaponTEISR)this.getTileEntityItemStackRenderer()).sawedOff;
	}
