...
{	
	...
	{
		return stack.hasTagCompound() && stack.getTagCompound().getInteger("magazine") > 1 ? 50 : 30;
	}
	...
	{
		return ((WeaponTEISR)this.getTileEntityItemStackRenderer()).tommygun;
	}
